...
export async function getPortfolioStatus(): Promise<PortfolioConnectionStatus> {
  return fetchJson<PortfolioConnectionStatus>("/api/portfolio/status");
}

export async function getPortfolioDashboard(): Promise<PortfolioDashboardSnapshot> {
  return fetchJson<PortfolioDashboardSnapshot>("/api/portfolio/dashboard");
}

export async function refreshPortfolioDashboard(): Promise<PortfolioRefreshResult> {
  return fetchJson<PortfolioRefreshResult>("/api/portfolio/refresh", { method: "POST" });
}

export function dashboardToChatState(dashboard: PortfolioDashboardSnapshot): ChatState {
...
export function streamErrorFromException(error: unknown): StreamError {
...
function allocationRowsFromSnapshot(snapshot: PortfolioSnapshot): AllocationRow[] {
  return [
...
function effectiveCashFromMetrics(
...
function dashboardSummary(dashboard: PortfolioDashboardSnapshot): string {
...
function weight(value: number, total: number): number {
